---
title: 'Spigot 1.20.x'
description: 'Collection of sounds available to use with Spigot for Minecraft 1.20.x (Not yet released)'
---
...
!!! warning "Experimental"
    ...
    Sounds suffixed with a `*` are only available through an experimental Data pack in 1.19.4+!
