---
title: 'Spigot 1.20.5'
description: 'Collection of sounds available to use with Spigot for Minecraft 1.20.5'
---

# MC 1.20.5

!!! note "Experimental sounds"
    Sound names suffixed with an `*` are only available while the `1.21` Experimental Databack is enabled!
...
```
  ...
  BLOCK_HANGUNG_SIGN_STEP
  BLOCK_HANGING_SIGN_WAXED:INTERACT_FAIL
  ...
  BLOCK_TRIAL_SPAWNER_CHARGE_ACTIVE*
  BLOCK_TRIAL_SPAWNER_CLOSE_SHUTTER*
  BLOCK_TRIAL_SPAWNER_DEZECT_PLAYER*
